...
- (NSURLConnection *)createConnection;
{
    ...
    //NSLog(@"Make a URL request: %@ %@ %@",startRequest.URL, [[NSString alloc] initWithData:[startRequest HTTPBody] encoding:NSUTF8StringEncoding], [startRequest valueForHTTPHeaderField:@"Authorization"]);
